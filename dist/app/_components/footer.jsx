      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            {!isSubmitted ? (<form onSubmit={handleSubmit} className="flex">
                <input type="tel" placeholder="Seu Melhor Número de Celular" value={cell} onChange={(e) => setCell(e.target.value)} required className="flex-grow px-3 py-2 bg-gray-700 text-white rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500"/>
                <button type="submit" className="bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-r-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                  <Send size={20}/>
